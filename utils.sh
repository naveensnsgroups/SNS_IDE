...
APP_NAME="${APP_NAME:-SNS Workbench}"
APP_NAME_LC="$( echo "${APP_NAME}" | awk '{print tolower($0)}' )"
ASSETS_REPOSITORY="${ASSETS_REPOSITORY:-SNS/workbench}"
BINARY_NAME="${BINARY_NAME:-snswb}"
GH_REPO_PATH="${GH_REPO_PATH:-SNS/workbench}"
ORG_NAME="${ORG_NAME:-SNS}"
